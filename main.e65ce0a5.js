(this.wordle = this.wordle || {}),
  (this.wordle.bundle = (function (e) {
    ...
    var La = ["rotom","zorua","klang","yanma","numel","toxel","inkay","tepig","zubat","luxio","ho-oh","budew","paras","riolu","klink","entei","absol","eevee","goomy","doduo","snivy","ditto","bagon","gible","hoopa","lotad","pichu","aipom","munna","arbok","golem","shinx","ekans","magby","kubfu","lugia","minun","unown","azelf","throh","gloom","deino","ralts","burmy","hypno"],
    Ta = ["rotom","zorua","klang","yanma","numel","toxel","inkay","tepig","zubat","luxio","ho-oh","budew","paras","riolu","klink","entei","absol","eevee","goomy","doduo","snivy","ditto","bagon","gible","hoopa","lotad","pichu","aipom","munna","arbok","golem","shinx","ekans","magby","kubfu","lugia","minun","unown","azelf","throh","gloom","deino","ralts","burmy","hypno"],
      Ia = "present",
      Ma = "correct",
      Oa = "absent";
